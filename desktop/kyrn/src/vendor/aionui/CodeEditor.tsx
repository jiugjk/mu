 ...
 * KYRN adaptation: standalone theme prop, no AionCore or settings bridge.
 */
...
import { codeEditorFontTheme, codeEditorSurfaceTheme, getCodeEditorBaseTheme } from './codeEditorTheme';
import { loadLanguageSupport, shouldDisableHighlighting } from './languageLoader';
