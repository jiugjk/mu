...
import { DROPDOWN_SEARCH_THRESHOLD, thoughtLevelOptionLabel } from '@/renderer/components/agent/runtimeSelectorOptions';
          ...
          >
            ...
            >
              ...
              {thoughtLevelOptions.map((option) => {
                // Agents report pi's levels by id ("xhigh"): name those in the app language.
                const label = thoughtLevelOptionLabel(t, option);
                return (
                  <Select.Option key={`${localeKey}-${option.value}`} value={option.value}>
                    {option.description ? (
                      <Tooltip content={option.description} position='right'>
