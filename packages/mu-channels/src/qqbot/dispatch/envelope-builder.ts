 ...
 */
function mapHistory(entries: HistoryEntry[] | undefined): OpenClawInboundMessage["history"] {
 ...
 */
function mapQuote(quote: ResolvedQuote | undefined): OpenClawInboundMessage["quote"] {
